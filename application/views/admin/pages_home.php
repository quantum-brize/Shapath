            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body row">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('admin/Pages/update_quotes')?>" method="POST">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" value="" placeholder="Quote" required name="quote"><?=$top_quote['quote']?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput2">Quote Author</label>
                                    <input type="text" class="form-control" name="quote_author" value="<?= $top_quote['quote_by']?>" placeholder="Quote Author" required>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-xl-6 col-lg-6 card shadow">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" action="<?=base_url('admin/Pages/update_quotes')?>" method="POST">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Quote</label>
                                    <textarea type="text" class="form-control" id="" value="" placeholder="Quote" name="quote" required ><?=$bottom_quote['quote']?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput2">Quote Author</label>
                                    <input type="text" class="form-control" id="" name="quote_author" value="<?=$bottom_quote['quote_by']?>" placeholder="Quote Author" required />
                                </div>
                                <div class='form-group' id="imagePreview">
                                    <div>
                                        <label for="formGroupExampleInput2">Quote image</label>
                                    </div>
                                    <img src="<?= base_url($bottom_quote['quote_img'])?>" height="100" id="quote_img" />
                                </div>
                                <div class="form-group">
                                    <input type="file" class="form-control-file" placeholder="Quote image" name="quote_img[]" />
                                </div>
                                <div class="form-group">
